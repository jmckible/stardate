...
#     transaction.new.vendor_name.should be_nil
#   end
#
...
#     transaction.on(Date.new(2008, 1, 1)).size.should == 3
#   end
#
#   it 'should find by vendor' do
#     transaction.from_vendor(vendors(:default)).size.should == 2
#     transaction.from_vendor(nil).size.should == transaction.count
#   end
#
#   # it 'should find by tag' do
#   #   transaction.find_tagged_with('default').size.should == 2
#   #   transaction.find_tagged_with(tags(:default)).size.should == 2
#   #   transaction.from_vendor(vendors(:default)).find_tagged_with(tags(:default)).size.should == 1
#   # end
#
#   it 'should find single tagged' do
#     transaction.tagged_with(tags(:default)).count.should == 2
#   end
#
#   it 'should find multipe tags' do
#     transaction.tagged_with(tags(:default, :other)).count.should == 3
#   end
#
#   #####################################################################
#   #                        L I F E    C Y C L E                       #
...
#     transaction = transaction.new :date=>Date.today, :explicit_value=>10
#     transaction.save
...
#     transaction = transaction.new :date=>Date.today, :start=>(Date.today - 9), :finish=>Date.today, :explicit_value=>'+10'
#     transaction.save
...
#     transaction = transaction.new :date=>Date.today, :finish=>(Date.today - 9), :start=>Date.today, :explicit_value=>'+10'
#     transaction.save
#     transaction.start.should == Date.today - 9
#     transaction.finish.should == Date.today
#     transaction.per_diem.should == 1
...
#     transaction.new.should have(1).error_on(:date)
#   end
#
#   it 'should have a user_id' do
#     transaction.new.should have(1).error_on(:user_id)
#   end
#
#   #####################################################################
